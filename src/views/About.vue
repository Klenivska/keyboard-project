...
<div>
  ...
  <p>
   It's a single page web application which implements simple typing trainer.
  </p>
  ...
  <p>
    Made by Tania Klenivska<br>
    <a target="_blank" rel="noopener noreferrer" href="https://github.com/Klenivska/keyboard-project.git">GitHub</a>.
  </p>
  </div>
</template>
